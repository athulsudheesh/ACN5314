function [desiredresponse,inputvectors,betamatrix] = unpacklogistic(thetavector,constants,thedata)
% USAGE: [desiredresponse,inputvectors,betamatrix] = unpacklogistic(thetavector,constants,thedata)
