classdef Linear
    ...
    methods (Static)
        function constants = Initialize(StepSize)
%           Model Structure 
...
%           Optimization Strategy 
            constants.optimizemethod.adaptivelearning = 'Adaptive (on-line)';         % Learning Mode
            constants.optimizemethod.searchdirection = 'momentumdirection';          % Search Method
