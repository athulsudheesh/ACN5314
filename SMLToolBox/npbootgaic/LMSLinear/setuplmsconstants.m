...
prompt={'Datafilename:','Number of Targets:',...
    'Interpretation Threshold:','Maximum Iterations:','Number of Bootstraps:'};
name='Linear Machine';
numlines=1;
defaultanswer={'irisdata3.xlsx','3','0.1','200','1000'};
options.Resize='on';
