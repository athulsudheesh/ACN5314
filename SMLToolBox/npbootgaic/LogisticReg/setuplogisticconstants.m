function [constants,thedata] = setuplogisticconstants;
...
datafilename = 'irisdata3.xlsx';
datafilename = 'CTG_formatted_NORM2.xls';
datafilename = 'car_TEST1.xls';
prompt={'Datafilename:','Number of Targets:','Interpretation Threshold:','Maximum Iterations:','Number of Bootstraps:'};
name='Linear Machine';
numlines=1;
defaultanswer={datafilename,'1','0.1','200','1000'};
options.Resize='on';
