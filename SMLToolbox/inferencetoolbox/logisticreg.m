function perform = logisticreg(dodisplay,estimationonly,varnames,dataset,constants)
% USAGE: perform = logisticreg(dodisplay,estimationonly,varnames,dataset,constants)
...
while keepgoing,
    ...
    errorsignal = -(targ - prob);  % this is a row vector
