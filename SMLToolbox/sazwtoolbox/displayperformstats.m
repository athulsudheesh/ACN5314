function displayperformstats(performancehistory)
% USAGE: displayperformstats(performancehistory)

perform = performancehistory;
disp('Performance Results for Estimating Parameters on this Data Set.');
disp(['Gradmax = ',num2str(perform.finalgradval),', Hessian Condition No. = ',num2str(perform.hesscondnum),', OPG Condition No. = ',num2str(opgcondnum)]);
